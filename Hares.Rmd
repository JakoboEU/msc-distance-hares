...
hist(data$distance_from_obs,main="",xlab="Distance from Observer (m)", breaks=12)
...
```{r}
model <- ds(data , key="hr", adjustment="herm", truncation=400, formula=~size,
            cutpoints = c(0,25,50,90,150,220,300,400),
