...
data$smeared_angle = abs(data$angle + (data$smear * 10))
...
```{r}
d.uniform.poly <- ds(data, key="unif", adjustment="poly",
             region.table = regions, sample.table = samples, obs.table = observations)
d.halfnorm.cos <- ds(data, key="hn", adjustment="cos",
             region.table = regions, sample.table = samples, obs.table = observations)
d.hazard.herm <- ds(data, key="hr", adjustment="herm",
             region.table = regions, sample.table = samples, obs.table = observations)
s.uniform.poly <- ds(sdata, key="unif", adjustment="poly",
             region.table = regions, sample.table = samples, obs.table = observations)
s.halfnorm.cos <- ds(sdata, key="hn", adjustment="cos",
             region.table = regions, sample.table = samples, obs.table = observations)
s.hazard.herm <- ds(sdata, key="hr", adjustment="herm",
             region.table = regions, sample.table = samples, obs.table = observations)
```
